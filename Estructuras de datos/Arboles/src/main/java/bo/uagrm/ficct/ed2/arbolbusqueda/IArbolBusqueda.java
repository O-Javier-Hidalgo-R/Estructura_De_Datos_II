...
/**
 * Interfaz usada para implementar el comportamiento regular o comun de un 
 * arbol de busqueda, se usa dos variables genericas para indicar el valor y la 
 * clave que se almacenaran en la estructura (binario, avl, mvias, b). <br>
 * Recuerda que un arbol de busqueda se caracteriza por ser:<br>
